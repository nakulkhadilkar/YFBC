...
# Account Information
to = 'vinkhadilkar@gmail.com' # Email to send to.
gmail_user = 'khadilkar.vinod@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'valachil' # Gmail password.
...
ip_lines = list(filter(None.__ne__, data))
ip_lines = str(ip_lines[0])
split_line_a = ip_lines[0:ip_lines.index('\\n')-1].split()
split_line_b = ip_lines[ip_lines.index('\\n')+2:len(ip_lines)-4].split()
print(split_line_a)
print(split_line_b)
